...
Page({
  ...
  getInfo(id){
    ...
    wx.request({
      ...
      success:function(res){
        ...
        that.setData({
          bgImage:'https://image.supconit.net' + '/' + res.data.obj.hits[0]._source.cover.split(',')[0]
        })
   ...
   */
  getpicture(e){
    var qualificationId=e.currentTarget.dataset.id;
    console.log(qualificationId)
wx.navigateTo({
  url: '/pages/qualificationPictures/index?id=' + qualificationId,
})
  },
